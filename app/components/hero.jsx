    ...
    <section id="hero" style={{
      ...
      <style>{`
        @media (max-width: 767px) {
          .ft-hero-inner { padding: 2.5rem 1.25rem 7rem !important; }
          .ft-hero-grid { grid-template-columns: 1fr !important; gap: 2rem !important; }
          .ft-hero-photo { display: none !important; }
          .ft-role-badge { font-size: 10px !important; padding: 5px 10px !important; white-space: normal !important; word-break: break-word !important; }
          .ft-stats-row { flex-wrap: wrap !important; gap: 1.5rem !important; padding-top: 1.5rem !important; }
          .ft-stat-item { padding-right: 0 !important; margin-right: 0 !important; border-right: none !important; min-width: 80px !important; }
          .ft-cta-row { gap: 10px !important; }
        }
      `}</style>
      {/* Decorative grid */}
      <div style={{
        ...
        <div className="ft-hero-grid" style={{
          ...
          <div>
            ...
            <motion.div {...fadeUp(0)} style={{ marginBottom: "1.8rem" }}>
              <span className="ft-role-badge" style={{
            ...
            {/* CTAs */}
            <motion.div {...fadeUp(0.3)} className="ft-cta-row" style={{ display: "flex", flexWrap: "wrap", gap: "12px", alignItems: "center", marginBottom: "3rem" }}>
              <button
            ...
            {/* Stats row */}
            {stats.length > 0 && (
              <motion.div {...fadeUp(0.4)} className="ft-stats-row" style={{
                display: "flex", gap: "0",
                borderTop: "1px solid #e2e8f0",
                paddingTop: "2rem",
              }}>
                {stats.map((stat, i) => (
                  <div key={i} className="ft-stat-item" style={{
                    paddingRight: "2.5rem",
                    marginRight: "2.5rem",
